...
def scarpTmxQuarter(ticker):
    ...
    for count,quarter in enumerate(QuarterlyResponse):
        ...
        QuarterlyResponse[count]["IncomeStatement"] = {
            ...
            ,**checkJsonKey(QuarterlyResponse,"IncomeStatement",currentQuarterIs, "IncomefromAssociatesandOtherParticipatingInterests","Income from Associates and Other Participating Interests") #financials
        ...
        QuarterlyResponse[count]["BalanceSheet"] = {
            ...
            ,**checkJsonKey(QuarterlyResponse,"BalanceSheet",currentQuarterBs, "FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchase", "Federal Funds Purchased and Securities Sold Under Agreement to Repurchase") #financials
        ...
        QuarterlyResponse[count]["CashFlow"] = {
            ...
            ,**checkJsonKey(QuarterlyResponse,"CashFlow",currentQuarterCf,"ProceedsPaymentFederalFundsSoldAndSecuritiesPurchasedUnderAgreementToResell","Federal Funds Sold and Securities Purchased Under Agreement to Resell") #financials
...
def scarpTmxAnnual(ticker):
    ...
    for count,year in enumerate(AnnualResponse):
        ...
        AnnualResponse[count]["BalanceSheet"] = {
            ...
            ,**checkJsonKey(AnnualResponse,"BalanceSheet",currentYearBs, "FederalFundsPurchasedAndSecuritiesSoldUnderAgreementToRepurchase", "Federal Funds Purchased and Securities Sold Under Agreement to Repurchase") #financials
        ...
        AnnualResponse[count]["CashFlow"] = {
            ...
            ,**checkJsonKey(AnnualResponse,"CashFlow",currentYearCf,"ProceedsPaymentFederalFundsSoldAndSecuritiesPurchasedUnderAgreementToResell","Federal Funds Sold and Securities Purchased Under Agreement to Resell") #financials
